...
//        $service_requests= DB::table('service_requests')->join('customers', 'customers.id', '=', 'service_requests.user_id')
        $service_requests= DB::table('customers')->join('service_requests', 'customers.id', '=', 'service_requests.customer_id')
