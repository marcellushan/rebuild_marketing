...
Route::get('press_release/marcom_show/{id}', 'PressReleaseController@marcomShow')->middleware('auth');
...
Route::get('design_printing/marcom_show/{id}', 'DesignPrintingController@marcomShow')->middleware('auth');
...
Route::get('photography/marcom_show/{id}', 'PhotoController@marcomShow')->middleware('auth');
...
Route::get('videography/marcom_show/{id}', 'VideoController@marcomShow')->middleware('auth');
...
Route::get('presentation/marcom_show/{id}', 'PresentationController@marcomShow')->middleware('auth');
...
Route::get('social_media/marcom_show/{id}', 'SocialMediaController@marcomShow')->middleware('auth');
...
Route::get('paid_advertising/marcom_show/{id}', 'PaidAdvertisingController@marcomShow')->middleware('auth');
